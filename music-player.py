...
def addsongs():
    ...
    for s in temp_song:
        s=s.replace("C:/Users/shekh/OneDrive/Desktop/Songs","")
...
def Play():
    ...
    song=f'C:/Users/shekh/OneDrive/Desktop/Songs{song}'
...
def Previous():
    ...
    temp2=f'C:/Users/shekh/OneDrive/Desktop/Songs{temp2}'
...
def Next():
    ...
    temp=f'C:/Users/shekh/OneDrive/Desktop/Songs{temp}'
...
songs_list=Listbox(root,selectmode=SINGLE,bg="purple",fg="white",font=('times new roman',15),height=12,width=47,selectbackground="gray",selectforeground="black")
